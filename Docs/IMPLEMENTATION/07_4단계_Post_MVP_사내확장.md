...
읽기/발송 OAuth Token 분리와 명시적 상대 날짜 정규화 회귀를 추가해 2026-09-08 기준선 `170 passed`와 두 OAuth 경로의 `READY`를 확인했다. 이후 UI 메일 흐름 회귀 1건을 추가했고 2026-09-09 당시 최신 전체 회귀는 `171 passed`였다. 현재 제출 기준은 2026-09-15 `228 passed`다.
